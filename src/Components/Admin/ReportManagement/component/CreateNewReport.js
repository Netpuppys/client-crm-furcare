          ...
          <div className="flex gap-10 w-full">
              ...
              <div className="flex flex-col w-full">
                  ...
                  <select
                      ...
                      className="mt-1 p-2 border border-gray-300 focus:outline-none rounded-lg classic capitalize"
                  >
                      <option value={""}>Select</option>
                      {frequencyArray.map((item, index) => (
                          <option key={index} className="capitalize" value={item}>Every {item}</option>
                      ))}
                  </select>
              </div>
              <div className="flex flex-col w-full">
          ...
          <div className="">
              <div className="flex gap-2 cursor-pointer">
                  <input
                      ...
                      onChange={e => handleInputChange("generateInBackground", Boolean(e.target.value))}
