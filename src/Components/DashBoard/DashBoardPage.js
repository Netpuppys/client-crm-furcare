...
const cardData = [
  ...
  },
  {
    ...
    value: (
      <>
        <span className="text-[1rem]">INR</span> 11,000
      </>
    ),
    change: "+12%",
          ...
          <tr>
            <th className="p-3 font-medium">
              <div className="flex items-center gap-1">
                Source{" "}
                <img src={informationIcon} className="h-5" alt="Sort Icon" />
              </div>
            </th>
            <th className="p-3 font-medium">
              <div className="flex items-center gap-1">
  ...
  return (
    <div className="bg-[#EBF4FF] p-6">
      <div className="flex justify-between items-start mb-4 pr-2">
        ...
        <select className="border border-[#CACDD8] w-[86px] h-[36px] rounded-md px-2 focus:outline-none">
        ...
        <div className="w-[75%]">
          <div className="flex w-full gap-4">
            {cardData.map((card, index) => (
              <div
                key={index}
                className="bg-[#380E78] text-white px-4 py-6 rounded-md shadow-lg w-[33%]"
              >
          ...
          <div className="w-full shadow-2xl bg-white min-h-[20rem] mt-6 p-3">
            <div className="w-full flex items-center justify-between">
              <div className="flex items-center gap-4">
                ...
                <p className="font-medium">Leads (10)</p>
                <button className="px-4 py-2 disabled:bg-[#E1E3EA] disabled:border-[#E1E3EA] disabled:text-white bg-transparent text-accent-blue border border-accent-blue text-nowrap bg-accent-blue rounded-md font-medium leading-[1.25rem] text-sm">
                  View All
                </button>
              </div>
              ...
              <div className="flex items-center">
                <button
                  ...
                  className={`flex w-[20px] h-[20px] aspect-square items-center justify-center ${
                    viewType === "list"
                      ? "bg-[#4B5671] text-white"
                      : "text-[#4B5671]"
                  }`}
                >
                  <IoListOutline />
